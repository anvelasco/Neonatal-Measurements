...
void setup() {
  ...
  pinMode(34, INPUT); // set 34 pin as INPUT
...
void loop() {
 ...
 for( int i=0;i<5000;i++){                                            
      ...
      //Serial.println(i);
      myNex.writeNum("Nvoltage1.val", i); // Nvoltage.val is a variable that we have create on Nextion.        
      myNex.writeNum("Nvoltage2.val", i*3); // Nvoltage.val is a variable that we have create on Nextion.        
      myNex.writeNum("Nvoltage3.val", i*5); // Nvoltage.val is a variable that we have create on Nextion.        
